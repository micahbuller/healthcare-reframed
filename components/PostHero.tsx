  ...
  return (
    <div className="flex justify-start items-center">
      <Link
        ...
        className="text-lg font-sans border-2 rounded-full py-4 px-8 border-[#2F2C2C] text-[#2F2C2C] flex items-center space-x-3 transition-all duration-300 hover:bg-[#2F2C2C] hover:text-white"
      >
  ...
  return (
    <div ref={ref} className="flex flex-col md:flex-row w-full space-y-6 md:space-x-6">
      ...
      <div className="flex flex-col w-full space-y-6">
        <h3 className="text-2xl md:text-3xl font-mono uppercase text-[#2F2C2C]">{heading}</h3>
