  ...
  if (status === "success") {
    return (
      <div className="bg-[#2F2C2C] rounded-3xl p-10 text-center space-y-4">
        ...
        <p className="font-sans text-background/70">Thanks for reaching out. We&apos;ll be in touch soon.</p>
        <button
          onClick={() => setStatus("idle")}
          className="mt-4 font-mono uppercase text-sm px-8 py-3 rounded-full border border-background/20 text-background/60 hover:text-[#EC7A5B] hover:border-[#EC7A5B]/40 transition-colors"
        >
          Send another
        </button>
      </div>
