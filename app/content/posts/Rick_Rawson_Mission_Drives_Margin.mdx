...
tags:
  ...
  - System Reform
  - Rural Health
guestName: "Rick Rawson"
guestTitle: "Former Senior Healthcare Executive · 40 Years Hospital Leadership"
guestBio: "Rick Rawson spent four decades as a senior healthcare executive, including as CEO of multi-hospital health systems serving rural communities. Over a career spanning community hospitals and regional systems, he developed a contrarian playbook: when other executives cut costs and chased higher-margin procedures, he invested in mission, community access, and the services that made the most difference to the most vulnerable. The result was systems that tripled revenue and outperformed competitors who followed conventional wisdom."
guestLinks: []
peopleMentioned:
  - { label: "Peter Block — Consultant, author of Community: The Structure of Belonging", url: "https://www.peterblock.com" }
booksMentioned:
  - { label: "Community: The Structure of Belonging — Peter Block", url: "https://www.bookshop.org/p/books/community-the-structure-of-belonging-peter-block/7539280" }
showNotes: "Every hospital consultant will tell you to cut costs, reduce services, and focus on high-margin procedures. Rick Rawson spent 40 years proving them wrong. In this conversation, he explains why cost-cutting healthcare strategy destroys the trust and community loyalty that sustain health systems long-term — and what a mission-first approach actually looks like in practice. His stories of tripling revenue by doing the opposite of what MBAs recommend are equal parts inspiring and infuriating. This is essential listening for anyone who believes healthcare leaders have no choice but to play by the existing rules."
timestamps:
  - { time: "0:00", label: "Trailer and Introduction" }
  - { time: "2:08", label: "Early Leadership Challenges and Financial Realities" }
  - { time: "6:49", label: "Reframing Healthcare Challenges and Business Models" }
  - { time: "11:22", label: "Growing Revenue and Community-Centered Care" }
  - { time: "13:50", label: "Metrics, Productivity, and Strategic Growth" }
  - { time: "17:07", label: "Consolidation, Community Disconnection, and Systemic Challenges" }
  - { time: "23:25", label: "Capital Markets Influence and Nonprofit vs For-Profit Dynamics" }
  - { time: "28:33", label: "Leading Large Health Systems with a Community Focus" }
  - { time: "30:51", label: "Hospitals as Community Partners Beyond Clinical Care" }
  - { time: "34:00", label: "Pressure, Fear, and Leadership Accountability" }
  - { time: "35:54", label: "Systemic Power Dynamics and Community Empowerment" }
  - { time: "41:15", label: "Community Ownership and Trust in Healthcare Systems" }
  - { time: "43:30", label: "Fragility and Optimism in Healthcare Systems" }
  - { time: "47:08", label: "California's CalAIM Program and Community-Based Care" }
  - { time: "51:13", label: "Leadership Gaps and Strategic Community Partnerships" }
  - { time: "54:30", label: "Balancing Government, Community, and Private Sector Roles" }
  - { time: "57:51", label: "Innovation at the State and Community Level" }
  - { time: "61:58", label: "Profitability Through Value and Integrated Care Models" }
  - { time: "63:10", label: "Personal Motivation and Commitment to Healthcare Reform" }
  - { time: "64:46", label: "Persistence and Collaboration for System Change" }
  - { time: "67:36", label: "Trust, Transparency, and Accountability in Healthcare" }
  - { time: "69:50", label: "Innovation, Movements, and Community-Led Change" }
  - { time: "70:53", label: "Future Outlook: Innovation and Scaling Change" }
  - { time: "73:19", label: "Coaching Leaders to Overcome Burnout Through Purpose" }
  - { time: "75:39", label: "Aligning Organizational and Individual Purpose" }
  - { time: "78:43", label: "Mission, Margin, and Authentic Leadership" }
  - { time: "80:36", label: "Nonprofit Governance and System Mentality Challenges" }
  - { time: "83:57", label: "Board Accountability and Courage in Healthcare Governance" }
  - { time: "86:06", label: "Case Study: Steward Healthcare Collapse and Lessons Learned" }
  - { time: "90:31", label: "Closing Reflections and Future Questions" }
---
