...
date: "2025-07-31T07:00:00-07:00"
...
externalLink: "https://healthcare-reframed.shorthandstories.com/doug-eby-the-nuka-revolution/"
...
tags:
  ...
  - Health Equity
  - Community Health
guestName: "Southcentral Foundation — Nuka System of Care"
guestTitle: "Alaska Native-Owned & Operated Health System · Two-Time Malcolm Baldrige Award Winner"
guestBio: "Southcentral Foundation is an Alaska Native-owned and -operated nonprofit health care organization serving more than 65,000 Alaska Native and American Indian people in Anchorage and surrounding areas. Their Nuka System of Care — built entirely around the concept of 'customer-owners' rather than patients — has won the Malcolm Baldrige National Quality Award twice, the only health system to achieve that distinction. Their model proves that community ownership, deep continuity of care, and radical investment in trust can transform health outcomes even in under-resourced settings."
guestLinks:
  - { label: "Southcentral Foundation", url: "https://www.southcentralfoundation.com" }
  - { label: "Nuka System of Care", url: "https://www.southcentralfoundation.com/nuka-system-of-care/" }
  - { label: "Malcolm Baldrige Program", url: "https://www.nist.gov/baldrige" }
peopleMentioned:
  - { label: "Don Berwick — IHI co-founder, featured the Nuka model in medical education", url: "https://www.ihi.org" }
  - { label: "W. Edwards Deming — Quality management pioneer", url: "https://www.deming.org" }
booksMentioned: []
showNotes: "In one of the most remote and under-resourced corners of America, an Alaska Native-run health system built something the entire country should be studying. Southcentral Foundation's Nuka System of Care began in 1982 when Alaska Native leaders realized the Indian Health Service wasn't serving them — so they took over and redesigned everything. By centering customer-owners (not patients) in every decision, investing in relationships and trust, and building teams around whole-person wellbeing, they transformed outcomes and won two Baldrige Awards. This episode is a masterclass in what happens when communities control their own health care."
timestamps:
  - { time: "0:00", label: "Intro" }
  - { time: "3:13", label: "What Is a Customer-Owner?" }
  - { time: "6:55", label: "Personal Healthcare Journeys: Sonda and Doug's Stories" }
  - { time: "14:52", label: "Founding and Early Growth of Southcentral Foundation" }
  - { time: "19:21", label: "System Redesign and Financial Transformation" }
  - { time: "26:13", label: "From Exam Room to Smartphone: Rethinking Access" }
  - { time: "32:00", label: "Measuring Outcomes Through the Customer-Owner Lens" }
  - { time: "41:56", label: "Complex Adaptive Systems: the Bird and the Dartboard" }
  - { time: "52:52", label: "Human-Centered Metrics and Multigenerational Impact" }
  - { time: "1:18:19", label: "Challenges of Scaling and Sustainability" }
  - { time: "1:28:36", label: "Future of Nuka: Vision, Workforce, and Medical Education" }
---
