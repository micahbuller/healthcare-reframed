...
date: "2025-10-11T07:00:00-07:00"
...
tags:
  ...
  - Policy
guestName: "Dr. Elliott Fisher"
guestTitle: "Director Emeritus, The Dartmouth Institute for Health Policy & Clinical Practice"
...
guestLinks:
  - { label: "The Dartmouth Institute", url: "https://tdi.dartmouth.edu" }
  - { label: "Dartmouth Atlas of Health Care", url: "https://www.dartmouthatlas.org" }
  - { label: "Dr. Fisher's Website", url: "https://www.elliottfisher.org/" }
peopleMentioned:
  - { label: "Jack Wennberg — Pioneer of healthcare variation research, founder of the Dartmouth Atlas", url: "https://tdi.dartmouth.edu" }
  - { label: "Roger Fisher — Harvard professor, co-founder of the Program on Negotiation", url: "https://www.pon.harvard.edu" }
  - { label: "Mark McClellan — Former CMS & FDA administrator, key architect of ACOs", url: "https://healthpolicy.duke.edu/people/mark-mcclellan" }
  - { label: "W. Edwards Deming — Quality management pioneer", url: "https://www.deming.org" }
  - { label: "Martin Wolf — FT chief economics commentator", url: "https://www.ft.com/martin-wolf" }
booksMentioned:
  - { label: "The Crisis of Democratic Capitalism — Martin Wolf", url: "https://www.bookshop.org/p/books/the-crisis-of-democratic-capitalism-martin-wolf/18418085" }
  - { label: "The Great Reversal: How America Gave Up on Free Markets — Thomas Philippon", url: "https://www.bookshop.org/p/books/the-great-reversal-how-america-gave-up-on-free-markets-thomas-philippon/10553491" }
showNotes: "America spends more on healthcare than any nation on earth — and gets less for it. Dr. Elliott Fisher's decades of research, culminating in the Dartmouth Atlas, proved something the system desperately didn't want to hear: high spending doesn't equal high quality. In this episode, he walks through the original 'Variation Studies' findings, explains why Medicare's biggest spenders deliver worse care, and describes what a high-value system would actually look like. He also tackles the political challenge of changing incentive structures that reward volume over value — and why he remains cautiously optimistic."
timestamps:
  - { time: "0:00", label: "Introduction to Healthcare Spending and Outcomes" }
  - { time: "1:03", label: "Elliott Fisher's Background and Early Insights" }
  - { time: "5:28", label: "Personal Motivations and Family Influence" }
  - { time: "8:33", label: "Early Research on Variations in Medical Practice" }
  - { time: "12:21", label: "Challenges and Skepticism in the Medical Community" }
  - { time: "13:22", label: "Shared Decision-Making and Patient Preferences" }
  - { time: "16:47", label: "Physician-Patient Interaction in the Early 1980s" }
  - { time: "19:01", label: "Treatment Decisions and Patient Advocacy" }
  - { time: "21:28", label: "Choosing Wisely and Understanding Risks" }
  - { time: "23:05", label: "The Value of Time in Diagnosis" }
  - { time: "24:05", label: "Global Spread and Impact of Variation Research" }
  - { time: "25:16", label: "From Research to the Dartmouth Atlas" }
  - { time: "27:50", label: "Why the Research Was Unique & National Impact" }
  - { time: "29:38", label: "Four Decades of Progress in Healthcare" }
  - { time: "31:47", label: "Spending, Outcomes, & Hospital Utilization" }
  - { time: "37:04", label: "Policymaker Reactions and Political Context" }
  - { time: "38:41", label: "Development of Accountable Care Organizations" }
  - { time: "44:56", label: "Effectiveness and Challenges of ACOs" }
  - { time: "48:47", label: "Insurance Trends & High-Deductible Plans" }
  - { time: "52:12", label: "Reflections & the Need for All-Payer Models" }
  - { time: "54:31", label: "Quality Improvements & Remaining Gaps" }
  - { time: "56:08", label: "Case Study: Intermountain Healthcare's Success" }
  - { time: "58:19", label: "Pathways to Reform & Leadership" }
  - { time: "60:38", label: "Barriers to Change in Health Systems" }
  - { time: "62:40", label: "Hospital vs. Physician Roles in Care Delivery" }
  - { time: "63:37", label: "Medical Pricing & Systemic Reform" }
  - { time: "69:10", label: "Regulatory Models & Public Utility Commissions" }
  - { time: "69:44", label: "Financialization of Healthcare & Consequences" }
  - { time: "72:57", label: "Oversight & Competition in Healthcare Markets" }
  - { time: "74:12", label: "Controversies Around Competition & Choice" }
  - { time: "77:13", label: "Purpose & Leverage Points for Improvement" }
  - { time: "81:20", label: "Empathy, Compassion & the Future" }
  - { time: "82:14", label: "Measuring Success in Healthcare Reform" }
---

[🌐 Dr. Elliott Fisher's Website](https://www.elliottfisher.org/)
