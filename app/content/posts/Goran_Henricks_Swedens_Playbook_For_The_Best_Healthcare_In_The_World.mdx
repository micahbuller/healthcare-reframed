...
date: "2025-08-14T07:00:00-07:00"
...
externalLink: "https://healthcare-reframed.shorthandstories.com/deep-cuts-g-ran-henriks/"
...
tags:
  ...
  - Innovation
  - Quality Improvement
guestName: "Göran Henriks"
guestTitle: "Chief Executive for Learning & Innovation (Retired) · Region Jönköping, Sweden"
guestBio: "Göran Henriks served as Chief Executive for Learning and Innovation in Jönköping County, Sweden, for nearly 30 years — building one of the world's most celebrated examples of systematic quality improvement and co-production in healthcare delivery. Under his leadership, Jönköping became a global laboratory for what's possible when a health system commits fully to continuous learning, staff empowerment, and radical customization of care. He now advises health systems and governments worldwide, and is a faculty member at multiple international institutions including the Institute for Healthcare Improvement."
guestLinks:
  - { label: "Region Jönköping County", url: "https://www.regionjonkoping.se/en" }
  - { label: "Jönköping Academy", url: "https://ju.se/jonkopingacademy" }
  - { label: "Institute for Healthcare Improvement", url: "https://www.ihi.org" }
peopleMentioned:
  - { label: "Michael Porter — Harvard Business School, value-based healthcare framework", url: "https://www.hbs.edu/faculty/Pages/profile.aspx?facId=6532" }
  - { label: "Elizabeth Teisberg — Healthcare strategist, co-developer of value-based care", url: "https://dellmed.utexas.edu/team/elizabeth-teisberg" }
booksMentioned: []
showNotes: "Sweden's Jönköping County has become the model that every high-performing health system in the world studies. Under Göran Henriks' leadership over nearly three decades, they built a culture of continuous improvement that didn't depend on mandates or external pressure — it was driven by frontline staff who were trusted, trained, and empowered to redesign care around patients. In this conversation, Göran explains what Jönköping actually did differently, why 'co-production' is more than a buzzword, and what U.S. health systems would need to change structurally to achieve comparable results."
timestamps:
  - { time: "0:00", label: "Why Swedish Resilience Matters in Healthcare Leadership" }
  - { time: "7:44", label: "From Psychologist and Coach to Transformational Health Leader" }
  - { time: "11:54", label: "The Colon Cancer Case Study: Confronting Inconvenient Data" }
  - { time: "21:21", label: "Inside Sweden's Healthcare Model: Funding, Fairness, and Flexibility" }
  - { time: "31:04", label: "Eliminating Hospital CEOs: How Horizontal Leadership Boosts Outcomes" }
  - { time: "38:26", label: "The Esther Project: Radical Customization Through Patient Journeys" }
  - { time: "53:43", label: "Trust as the Antidote to Burnout in an Anxiety Industry" }
  - { time: "59:00", label: "Measuring What Matters: Years of Active Life After 65" }
  - { time: "1:09:20", label: "Building Leadership Capacity: 550 Leaders, 5 Strategic Meetings a Year" }
  - { time: "1:13:41", label: "Co-Production in Action: How Self-Dialysis Changed Everything" }
  - { time: "1:19:26", label: "What US Healthcare Leaders Can Learn from Jonkoping" }
  - { time: "1:25:25", label: "The Ultimate Leverage Point: Honesty and Moral Alignment" }
---
