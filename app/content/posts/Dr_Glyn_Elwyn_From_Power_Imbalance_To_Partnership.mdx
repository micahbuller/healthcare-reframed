...
tags:
  ...
  - Innovation
guestName: "Dr. Glyn Elwyn"
guestTitle: "Professor, The Dartmouth Institute · World Leader in Shared Decision Making"
guestBio: "Dr. Glyn Elwyn is a professor at The Dartmouth Institute and the world's foremost researcher on shared decision-making (SDM) in clinical practice. Born in rural Wales, he took an unconventional path through arts and emergency medicine before dedicating his career to ensuring patients have a genuine voice in their own care. He created the Option Grid decision aids and the Observer OPTION-5 and CollaboRATE measurement tools — now used globally to evaluate how well clinicians partner with patients. He has published over 400 peer-reviewed articles and remains a leading voice on how technology can enable — or undermine — true co-production in healthcare."
guestLinks:
  - { label: "The Dartmouth Institute", url: "https://tdi.dartmouth.edu" }
  - { label: "Option Grid Decision Aids", url: "https://www.optiongrid.org" }
  - { label: "glynelwyn.com", url: "https://www.glynelwyn.com" }
peopleMentioned:
  - { label: "Jack Wennberg — Dartmouth, pioneer of healthcare variation research", url: "https://tdi.dartmouth.edu" }
  - { label: "Al Mulley — Dartmouth physician, shared decision-making pioneer", url: "https://tdi.dartmouth.edu" }
  - { label: "Annette O'Connor — Ottawa researcher, pioneer in patient decision aids", url: "https://www.ohri.ca/programs/clinical_epidemiology/oconnor.asp" }
booksMentioned: []
showNotes: "Every physician believes they involve their patients in decisions. The research says they're wrong. Dr. Glyn Elwyn has spent 30 years measuring the gap between what clinicians think they do and what patients actually experience — and the gap is vast. In this conversation, he explains why shared decision-making is so difficult to sustain, what tools like Option Grids do that conversation alone cannot, and how the rise of ambient AI listening in exam rooms could either amplify or destroy the patient-clinician relationship. He also speaks candidly about burnout, moral injury, and why the best protection against both is restoring meaning to the clinical encounter."
timestamps:
  - { time: "0:00", label: "Intro" }
  - { time: "1:18", label: "Introducing Dr. Glyn Elwyn and co-production in healthcare" }
  - { time: "3:00", label: "Dr. Glyn Elwyn's personal background and early education" }
  - { time: "10:06", label: "Impact of arts education on medical practice" }
  - { time: "12:01", label: "Entering medical school and early medical career" }
  - { time: "16:07", label: "Development of shared decision-making measurement tools" }
  - { time: "19:39", label: "Challenges and early reception of shared decision making" }
  - { time: "22:27", label: "Philosophy and practicalities of shared decision making" }
  - { time: "26:41", label: "Benefits of SDM on outcomes and utilization" }
  - { time: "28:47", label: "Career progression and expansion of SDM research" }
  - { time: "30:13", label: "Creation and impact of the Option Grid tool" }
  - { time: "31:51", label: "Importance of measurement tools: CollaboRATE, Integrate, Considerate" }
  - { time: "35:36", label: "Frustrations with adoption of SDM measures" }
  - { time: "37:18", label: "Benefits of SDM for clinicians and patients" }
  - { time: "42:15", label: "Role of insurers and leadership in implementing SDM" }
  - { time: "44:29", label: "Impact of decision aids on costs and utilization" }
  - { time: "45:10", label: "Learning health systems: examples and challenges" }
  - { time: "50:01", label: "Comparing Welsh and American healthcare perspectives" }
  - { time: "51:48", label: "Applying SDM in a multicultural practice" }
  - { time: "55:17", label: "Limits of SDM in complex addiction cases" }
  - { time: "56:13", label: "Scaling SDM to community and cultural challenges" }
  - { time: "58:50", label: "SDM and physician burnout" }
  - { time: "1:03:46", label: "Balancing Physician Productivity and Quality Care" }
  - { time: "1:05:10", label: "Addressing Demand and Access Issues in Primary Care" }
  - { time: "1:06:58", label: "Future Directions and Implementation Challenges" }
  - { time: "1:08:48", label: "Policy and System-Level Perspectives on Shared Decision Making" }
  - { time: "1:10:22", label: "Reflections on Healthcare Spending and Systemic Issues" }
  - { time: "1:12:29", label: "Call for Leadership and Vision in Healthcare Reform" }
  - { time: "1:14:13", label: "Closing Thoughts and Legacy of Shared Decision Making Advocacy" }
---
**Judson Howe**
