...
date: "2025-08-28T07:00:00-07:00"
...
tags:
  ...
  - Leadership
  - Innovation
guestName: "Maureen Bisognano"
guestTitle: "President Emerita & Senior Fellow, Institute for Healthcare Improvement"
guestBio: "Maureen Bisognano served as President and CEO of the Institute for Healthcare Improvement (IHI) for over a decade, following a career that began at the bedside as a nurse. Under her leadership, IHI became the world's leading organization for spreading improvement science across health systems in more than 65 countries. She championed the transformative shift from 'What's the matter with you?' to 'What matters to you?' — a question that changes the entire dynamic of care. She is a sought-after speaker, author, and advisor who believes the best healthcare system in the world is one where people rarely need to use hospitals at all."
guestLinks:
  - { label: "Institute for Healthcare Improvement", url: "https://www.ihi.org" }
peopleMentioned:
  - { label: "Don Berwick — Pediatrician, IHI co-founder", url: "https://www.ihi.org" }
  - { label: "Paul Batalden — IHI co-founder, coined 'co-production' in healthcare", url: "https://www.ihi.org" }
  - { label: "Vivek Murthy — U.S. Surgeon General, loneliness research", url: "https://www.hhs.gov/surgeongeneral" }
booksMentioned:
...
showNotes: "You can't buy health at a hospital. That's the provocative premise Maureen Bisognano has spent her career proving — and acting on. In this conversation, she shares the personal moment that changed her understanding of what patients actually need, why the simple question 'What matters to you?' is more powerful than any clinical protocol, and what she's seen in systems that have made the shift from treating illness to building health. She speaks candidly about the gap between where U.S. healthcare is and where it could be — and why the gap is finally starting to close."
timestamps:
  - { time: "1:41", label: "Home, Hope, and Whole-Person Care" }
  - { time: "5:53", label: "From Bedside to IHI: Purpose to Platform" }
  - { time: "7:47", label: "'Some Is Not a Number': 100,000 Lives Campaign" }
  - { time: "10:08", label: "Upstream Health: Prevention Before Admission" }
  - { time: "18:21", label: "Co-Production in Action: Patient-Led Dialysis" }
  - { time: "25:49", label: "Recovery Colleges: A New Front Door for Mental Health" }
  - { time: "27:13", label: "Loneliness as Diagnosis: Belonging Is Medicine" }
  - { time: "40:40", label: "Will, Ideas, Execution: The IHI Change Formula" }
  - { time: "43:07", label: "Exnovation: Stop Doing What Adds No Value" }
  - { time: "50:53", label: "Redesigning Rural Hospitals: Community Health Centers" }
  - { time: "54:26", label: "First KPI: Workforce and Family Health" }
---
