...
date: "2025-07-24T07:00:00-07:00"
...
imageUrl: "https://res.cloudinary.com/mindflip/image/upload/v1753457576/healthcare%20reframed/Episodes/002_Somava_Saha/2_Corrected_xnfckd.png"
...
tags:
  ...
  - Leadership
  - Mission-Driven
guestName: "Dr. Somava Saha"
guestTitle: "Physician & Health Equity Leader · Former Executive, IHI & Well Being Trust"
guestBio: "Dr. Somava (Soma) Saha is a physician-executive who has led some of the most influential transformation efforts in American health care. She served as Executive Vice President at the Institute for Healthcare Improvement and as CEO of Well Being Trust, a national foundation focused on mental health and flourishing. A primary care physician by training, she has dedicated her career to proving that health equity isn't a moral luxury — it's a strategic imperative. She helps health systems see equity as the path to abundance rather than a trade-off against margin."
guestLinks:
  - { label: "Well Being Trust", url: "https://www.wellbeingtrust.org" }
  - { label: "Institute for Healthcare Improvement", url: "https://www.ihi.org" }
peopleMentioned:
  - { label: "Donella Meadows — Systems thinker, author of Thinking in Systems", url: "https://www.donellameadows.org" }
booksMentioned:
  - { label: "Thinking in Systems: A Primer — Donella Meadows", url: "https://www.bookshop.org/p/books/thinking-in-systems-donella-meadows/7394925" }
showNotes: "For decades, health system executives have framed equity work as a cost center — the right thing to do, but expensive. Dr. Soma Saha has spent her career dismantling that argument. In this conversation, she makes the case that equitable care is actually the most financially sustainable form of care — that investing in communities' vital conditions reduces downstream utilization, strengthens loyalty, and builds the mission-driven culture that attracts the best talent. She challenges the 'no margin, no mission' excuse and offers a new framework: equity as the engine of abundance."
timestamps:
  - { time: "0:00", label: "System Misaligned: 'The Emperor Has No Clothes'" }
  - { time: "9:10", label: "Burning Platform: Global Payments vs. Fee-for-Service" }
  - { time: "17:30", label: "Mission Greater Than Margin: Team-Based, Patient-Centered Care" }
  - { time: "27:54", label: "Structural Inequity: Flexner to Modern Safety Nets" }
  - { time: "41:36", label: "Lessons from Guyana: 'It's Never the Money'" }
  - { time: "51:02", label: "Getting in Relationship: Decolonising Leadership" }
  - { time: "54:08", label: "Human Flourishing vs. ROI: Cantril's Ladder Metrics" }
  - { time: "59:15", label: "Restorative ROI: Anchor Strategy & Local Wealth" }
  - { time: "1:02:29", label: "Blank-Canvas Vision: Board Reform & Community Budgets" }
  - { time: "1:11:50", label: "Equity to Abundance: Launching Justice Squared" }
---
