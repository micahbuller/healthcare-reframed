...
export default function AboutPage() {
	...
	return (
		<div className="bg-[#FFFBF7] text-[#2F2C2C]">
			...
			<div className="bg-[#2F2C2C] py-20">
				<div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-16 items-start">
					<div className="space-y-6">
						<p className="font-sans text-base md:text-lg text-[#FFFBF7]/75 leading-relaxed">
					...
					<div className="border-l-4 border-[#EC7A5B] pl-10">
						<p className="font-mono text-xl md:text-2xl uppercase text-[#FFFBF7] leading-snug">
				...
				<div className="bg-[#2F2C2C] rounded-3xl p-8 md:p-12 transition-all duration-300">
					<div className="grid md:grid-cols-3 gap-8 items-start">
						<div>
							...
							<h3 className="font-mono text-3xl md:text-4xl uppercase text-[#FFFBF7] leading-tight mb-4">
								{selectedMember.name}
							</h3>
							{selectedMember.linkedin && (
								<Link
									...
									className="inline-flex items-center gap-2 font-mono text-xs uppercase tracking-widest text-[#FFFBF7]/60 border border-[#FFFBF7]/20 rounded-full px-4 py-2 hover:text-[#EC7A5B] hover:border-[#EC7A5B]/40 transition-colors"
								>
						...
						<div className="md:col-span-2">
							<p className="font-sans text-base text-[#FFFBF7]/70 leading-relaxed">
								{selectedMember.desc}
							</p>
						</div>
					</div>
			...
			<div className="relative overflow-hidden py-24 px-6 md:px-12">
				<div className="absolute inset-0 bg-gradient-to-br from-[#EC7A5B] to-[#c4513b]" />
